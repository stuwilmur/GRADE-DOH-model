...
const measuresToTest = new Map([
  ['primarySchoolTeacherToPupilRatio', coverage.target.primarySchoolTeacherToPupilRatio],
  ['lowerSchoolTeacherToPupilRatio', coverage.target.lowerSchoolTeacherToPupilRatio],
  ['upperSchoolTeacherToPupilRatio', coverage.target.upperSchoolTeacherToPupilRatio],
]);
