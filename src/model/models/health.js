...
export function createCoverageModel() {
  return mt
    ...
    .does((r) => safeInverse(r[constants.computedColumnNames.IMPROVED_PRIMARY_TEACHERS_TO_PUPILS])
    .end()
    .calc()
    ...
    .does((r) => safeInverse(r[constants.computedColumnNames.IMPROVED_LOWER_TEACHERS_TO_PUPILS])
    .end()
    .calc()
